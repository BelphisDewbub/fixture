...
export const NCAAF_TEAMS: Record<string, { id: number; name: string; logoUrl: string }> = {
  // SEC
  ...
  "army":              { id: 349,  name: "Army Black Knights",      logoUrl: "https://a.espncdn.com/i/teamlogos/ncaa/500/349.png" },
  "navy":              { id: 2426, name: "Navy Midshipmen",         logoUrl: "https://a.espncdn.com/i/teamlogos/ncaa/500/2426.png" },
  // Mountain West
  "air-force":         { id: 2005, name: "Air Force Falcons",       logoUrl: "https://a.espncdn.com/i/teamlogos/ncaa/500/2005.png" },
  "boise-state":       { id: 68,   name: "Boise State Broncos",     logoUrl: "https://a.espncdn.com/i/teamlogos/ncaa/500/68.png" },
  "colorado-state":    { id: 36,   name: "Colorado State Rams",     logoUrl: "https://a.espncdn.com/i/teamlogos/ncaa/500/36.png" },
  "fresno-state":      { id: 278,  name: "Fresno State Bulldogs",   logoUrl: "https://a.espncdn.com/i/teamlogos/ncaa/500/278.png" },
  "new-mexico":        { id: 167,  name: "New Mexico Lobos",        logoUrl: "https://a.espncdn.com/i/teamlogos/ncaa/500/167.png" },
  "san-diego-state":   { id: 21,   name: "San Diego State Aztecs",  logoUrl: "https://a.espncdn.com/i/teamlogos/ncaa/500/21.png" },
  "unlv":              { id: 2439, name: "UNLV Rebels",             logoUrl: "https://a.espncdn.com/i/teamlogos/ncaa/500/2439.png" },
  "utah-state":        { id: 328,  name: "Utah State Aggies",       logoUrl: "https://a.espncdn.com/i/teamlogos/ncaa/500/328.png" },
  "wyoming":           { id: 2751, name: "Wyoming Cowboys",         logoUrl: "https://a.espncdn.com/i/teamlogos/ncaa/500/2751.png" },
  // AAC & notable G5
  "east-carolina":     { id: 151,  name: "East Carolina Pirates",   logoUrl: "https://a.espncdn.com/i/teamlogos/ncaa/500/151.png" },
  "memphis":           { id: 235,  name: "Memphis Tigers",          logoUrl: "https://a.espncdn.com/i/teamlogos/ncaa/500/235.png" },
  "south-florida":     { id: 58,   name: "South Florida Bulls",     logoUrl: "https://a.espncdn.com/i/teamlogos/ncaa/500/58.png" },
  "tulane":            { id: 2655, name: "Tulane Green Wave",       logoUrl: "https://a.espncdn.com/i/teamlogos/ncaa/500/2655.png" },
  "tulsa":             { id: 2657, name: "Tulsa Golden Hurricane",  logoUrl: "https://a.espncdn.com/i/teamlogos/ncaa/500/2657.png" },
  "uab":               { id: 2430, name: "UAB Blazers",             logoUrl: "https://a.espncdn.com/i/teamlogos/ncaa/500/2430.png" },
};

export async function getNcaafTeamGames(teamSlug: string): Promise<Game[]> {
  const team = NCAAF_TEAMS[teamSlug];
  if (!team) return [];
  const events = await fetchTeamSchedule("football", "college-football", team.id);
  return events.map((e) => espnToGame(e, `NCAA Football ${e.season.year}`, "https://www.espn.com/college-football/schedule"));
}
